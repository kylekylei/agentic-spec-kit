...
#
# This script provides unified prerequisite checking for speckit workflow.
...
Consolidated prerequisite checking for speckit workflow.
...
if [[ ! -d "$TASK_DIR" ]]; then
    ...
    echo "Run /speckit.align first to create the task structure." >&2
    exit 1
fi
