...
```
/teammate.helpme
/teammate.helpme healthcheck
/teammate.helpme consult [問題]
/teammate.helpme assign
/teammate.helpme migrate
```
...
| **Audit** | `/teammate.audit` | 世界級產品體驗大師品質審計（產品交付最終把關）|
| **Help** | `/teammate.helpme` | 🧭 智慧導航、健康檢查、流程問診、Issue 指派、遷移 |
