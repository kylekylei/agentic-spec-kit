...
if [ ${#BRANCH_NAME} -gt $MAX_BRANCH_LENGTH ]; then
    ...
    >&2 echo "[speckit] Original: $ORIGINAL_BRANCH_NAME (${#ORIGINAL_BRANCH_NAME} bytes)"
...
# Set the SPECKIT_FEATURE environment variable for the current session
export SPECKIT_FEATURE="$BRANCH_NAME"
...
if $JSON_MODE; then
    ...
    echo "SPECKIT_FEATURE environment variable set to: $BRANCH_NAME"
fi
